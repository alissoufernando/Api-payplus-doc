<div>
    <div class="page-header theme-bg-dark py-5 text-center position-relative">
	    ...
	    <div class="container">
		    ...
		    <div class="page-intro single-col-max mx-auto">Intégrez PayPlus Africa dans vos applications.</div>
                ...
                <div class="col-12 col-lg-4 py-3">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <a class="card-link-mask" href="{{ route('documentations') }}#section-1"></a>
                        </div><!--//card-body-->
                    </div><!--//card-->
                </div><!--//col-->
                <div class="col-12 col-lg-4 py-3">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <a class="card-link-mask" href="{{ route('documentations') }}#section-2"></a>
                        </div><!--//card-body-->
                    </div><!--//card-->
                </div><!--//col-->
                <div class="col-12 col-lg-4 py-3">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <a class="card-link-mask" href="{{ route('documentations') }}#section-3"></a>
                        </div><!--//card-body-->
                    </div><!--//card-->
                </div><!--//col-->
                <div class="col-12 col-lg-4 py-3">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <a class="card-link-mask" href="{{ route('documentations') }}#section-4"></a>
                        </div><!--//card-body-->
                    </div><!--//card-->
                </div><!--//col-->
                <div class="col-12 col-lg-4 py-3">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <a class="card-link-mask" href="{{ route('documentations') }}#section-5"></a>
                        </div><!--//card-body-->
                    </div><!--//card-->
                </div><!--//col-->
                <div class="col-12 col-lg-4 py-3">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title mb-3">
                                ...
                                <span class="card-title-text">créer une application</span>
                            </h5>
                            <div class="card-text">
                                Section overview goes here. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet.
                            </div>
                            <a class="card-link-mask" href="{{ route('documentations') }}#section-6"></a>
                        </div><!--//card-body-->
                    </div><!--//card-->
                </div><!--//col-->
                {{-- <div class="col-12 col-lg-4 py-3">
